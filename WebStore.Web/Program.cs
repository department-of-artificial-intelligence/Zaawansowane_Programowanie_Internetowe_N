...
builder.Services.AddDbContext<ApplicationDbContext>(options =>
        options.UseSqlServer(
            builder.Configuration.GetConnectionString("ZPI")) //here you can define a database type.
);
builder.Services.Configure<JwtOptionsViewModel>(options => builder.Configuration.GetSection("JwtOptions").Bind(options));
