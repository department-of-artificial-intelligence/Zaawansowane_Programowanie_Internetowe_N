...
public class ProductApiController : BaseApiController
{
    ...
    [HttpPut]
    public IActionResult Put([FromBody] AddOrUpdateProductViewModel addOrUpdateProductVm)
    {
        return PostOrPutHelper(addOrUpdateProductVm);
    }
    [HttpPost]
    public IActionResult Post([FromBody] AddOrUpdateProductViewModel addOrUpdateProductVm)
    {
        return PostOrPutHelper(addOrUpdateProductVm);
    }
    ...
    private IActionResult PostOrPutHelper(AddOrUpdateProductViewModel addOrUpdateProductVm)
    {
        try
        {
