...
public class AccountApiController : BaseApiController
{
    ...
    private readonly JwtOptionsViewModel _jwtOptions;

    public AccountApiController(ILogger logger,
        IMapper mapper,
        IOptions<JwtOptionsViewModel> jwtOptions,
    ...
    public async Task<IActionResult> Login([FromForm] LoginUserVm applicationUser)
    {
        try
        {
            ...
            var result =
                await _signInManager.PasswordSignInAsync(applicationUser.Login, applicationUser.Password, true, false);
            ...
            var claims = new List<Claim>
            {
                ...
                new Claim(JwtRegisteredClaimNames.Exp,
                    ((long)((DateTime.Now.AddMinutes(_jwtOptions.TokenExpirationMinutes) - new DateTime(1970, 1, 1, 0,
                        0,
