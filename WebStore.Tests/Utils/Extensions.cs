...
namespace WebStore.Tests.Utils
{
    public static class Extensions
    {
        ...
        //add customer
        await dbContext.AddRangeAsync(DataProvider.PrepareCustomers());
        //add invoices
        await dbContext.AddRangeAsync(DataProvider.PrepareInvoices());
        //add addresses
        await dbContext.AddRangeAsync(DataProvider.PrepareAddresses());
        //add orders
        await dbContext.AddRangeAsync(DataProvider.PrepareOrders());
        //add stationarystores
        await dbContext.AddRangeAsync(DataProvider.PrepareStationaryStores());
