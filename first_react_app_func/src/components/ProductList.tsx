...
import { AddProductToListF } from "../components/AddProductToList";
    ...
    return (
        <div className="product-list">
            ...
            <div className="list-container">
                {
                    state.name !== "" &&
                    state.products.map((product: { id: any; name: any; type: any; price: any; }) =>
            ...
            <AddProductToListF submit={onAddNewProductSubmit}></AddProductToListF>
        </div>
    );
}