    ...
    public partial class Pierwsza : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StationaryStore", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StationaryStoreEmployees", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StationaryStoreEmployees_StationaryStore_StationaryStoreId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StationaryStoreEmployees_StationaryStoreId",
                table: "StationaryStoreEmployees",
                column: "StationaryStoreId");
        }
